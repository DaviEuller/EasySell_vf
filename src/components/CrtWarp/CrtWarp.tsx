...
export default function CRTWarp({
  ...
  useEffect(() => {
    ...
    // Listener no `window` (não no container) para funcionar mesmo quando o
    // container está dentro de um wrapper com `pointer-events: none`
    // (comum quando o CRTWarp é usado como background de página inteira).
